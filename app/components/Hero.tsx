...
const CallToAction = () => (
  <div className="w-full lg:w-fit flex flex-col items-center lg:items-start justify-center gap-2 max-w-[516px] order-2 lg:order-1">
    <button className="shadow-cyan bg-primary-pink rounded-[10px] px-10 py-2 text-white font-bold text-[20px] h-[40px] w-full lg:w-[313px] items-center justify-center flex cursor-pointer">
      {HERO_CONTENT.cta.buttonText} <ChevronIcon />
    </button>
...
const Headings = () => {
  const headingClasses = "text-[25px] lg:text-[35px] text-center lg:text-left font-bold font-urbanist";
...
const Hero = () => {
  const containerClasses = "w-full max-w-[1022px] flex flex-col lg:flex-row justify-center lg:justify-start items-center relative pb-4 lg:py-4 flex-1";
  const contentClasses = "flex flex-col items-center lg:items-start justify-center w-full max-w-[700px] lg:max-w-[516px] gap-6 lg:py-16 z-2";
  const legalTextClasses = "text-center lg:text-left w-full";
        ...
        <div className={contentClasses}>
          ...
          <div className="w-full flex flex-col gap-8 items-center lg:items-start pb-8">
            ...
            <div className="flex flex-col items-center justify-center lg:justify-start w-full gap-4 order-1 lg:order-2">
              <p className={`text-[12px] text-secondary ${legalTextClasses}`}>
                {HERO_CONTENT.legal.terms}
              </p>
              <small className={`text-[10px] text-secondary ${legalTextClasses}`}>
